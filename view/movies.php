...
if( $rating !== -2 )
{
    ...
    {
        echo 'Vaša ocijena: ' . '<span id="tvojaocijena">' . "Niste još ocijenili ovaj film!" . '</span>';
    }
    ...
    <input type="hidden" id="js_user_id" value="' . $_SESSION['id_user'] . '">
    <input type="hidden" id="js_movie_id" value="' . $movie->id . '">
