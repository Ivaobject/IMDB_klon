...
<head>
	<meta charset="utf8">
	<title>IMDB_klon</title>
	<style>
        body 
        { 
            font-family: "Trebuschet MS", Helvetica, sans-serif; 
            background-color: #C9CBA3;
            color: #723D46;
        }
        input { background-color:#FFE1A8; font-size: 30px; }
        input:hover 
        { 
...
<body>
    <h1><a href="index.php?rt=user/index">index</a></h1>   
